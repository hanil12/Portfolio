...
inline const std::string& PlayerData::name() const {
  // @@protoc_insertion_point(field_get:Protocol.PlayerData.name)
...
void PlayerData::set_name(ArgT0&& arg0, ArgT... args) {
 ...
 name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Protocol.PlayerData.name)
}
inline std::string* PlayerData::mutable_name() {
  // @@protoc_insertion_point(field_mutable:Protocol.PlayerData.name)
...
inline std::string* PlayerData::release_name() {
  // @@protoc_insertion_point(field_release:Protocol.PlayerData.name)
...
inline void PlayerData::set_allocated_name(std::string* name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Protocol.PlayerData.name)
}
